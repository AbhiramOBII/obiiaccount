    ...
    >
        ...
        <div class="border-t border-primary-700/50 p-4">
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('admin.settings.profile') }}" class="p-1.5 text-primary-300 hover:text-white hover:bg-white/10 rounded-lg transition-colors {{ request()->routeIs('admin.settings.*') ? 'text-white bg-white/10' : '' }}" title="Settings">
